...
include '../models/transaction_draft_model.php';
$page = null;
$page = (isset($_GET['page'])) ? $_GET['page'] : "list";
$title = ucfirst("Draft Transaksi");
...
switch ($page) {
  case 'list':
    ...
    include '../views/transaction_draft/transaction_draft_list.php';
    get_footer();
    break;
  ...
  case 'edit':
    ...
    case 'lanjutkan':
      ...
      mysql_query("INSERT INTO widget_tmp (wt_id,user_id,stock_id,jumlah,jumlah_konversi,unit_id,transaction_id,wt_desc,zak,printed) SELECT wt_id,user_id,stock_id,jumlah,jumlah_konversi,unit_id,transaction_id,wt_desc,zak,printed FROM transaction_draft WHERE transaction_id = '".$transaction_id."' ");
      $qwery = mysql_query("SELECT wt_id FROM transaction_draft WHERE transaction_id = '".$transaction_id."' ");
      $row = mysql_fetch_array($qwery);

      mysql_query("INSERT INTO widget_tmp_details (wtd_id, wt_id, item_id, keterangan_item) SELECT (wtd_id, wt_id, item_id, keterangan_item) FROM transaction_draft_det WHERE wt_id = '".$row."' ");

      delete_config("transaction_draft", "transaction_id = '$transaction_id'");
      delete_config("transaction_draft_det", "wt_id = '$row'");
