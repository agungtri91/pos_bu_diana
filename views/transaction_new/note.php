                            ...
                            <div class="box box-cokelat">
                                ...
                                <div class="box-body">
                                      ...
                                      <div class="col-md-6">
										<div class="input-group">
										  <span class="input-group-btn">
											<button class="btn btn-default text_popmodal" type="button" style="color:white; background-color:black" onclick="addminedt('min')">-</button>
										  </span>
											<input type="text" class="form-control text_popmodal" value="<?= $jumlah ?>" name="i_qty" id="i_qty"  />
										  <span class="input-group-btn">
											<button class="btn btn-default text_popmodal" type="button" style="color:white; background-color:black" onclick="addminedt('plus')">+</button>
										  </span>
										</div>
                                      </div>
                                    ...
                                    <?php
                                        ...
                                        <?php if($row_note_category['note_category_id'] == 1){
                                        ...
                                        <div class="form-group note_frame">
                                          ...
                                          <label class="blue" style="background-color: <?= $background_color ?>">
                                            ...
                                            <span  onclick="get_change(<?= $row_note['note_id']?>, <?= $row_note_category['note_category_id'] ?>)" id="i_span_<?= $row_note['note_id']?>" class="i_span_<?= $row_note_category['note_category_id']?>"><?= $row_note['note_name'] ?>
                                              ...
                                              <a href="transaction_new.php?page=delete_note&transaction_id=<?= $transaction_id ?>&wt_id=<?= $wt_id?>&id=<?= $link ?>" class="btn btn-danger" ><i class="fa fa-trash-o"></i></a>
                                            </div>
                                            <?php
                                            }
                                            ?>
