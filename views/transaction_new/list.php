		...
		<section class="content_checkout">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="col-xs-3">
						<div class="form-group">
							<a href="transaction_new.php?page=save_draft&transaction_id=<?=$transaction_id;?>" class="btn btn-danger button_checkout">Draft</a>
						</div>
					</div>
					<div class="col-xs-2">
						<a href="transaction_new.php?page=delete_tmp&transaction_id=<?=$transaction_id;?>" class="btn btn-danger">
							<i class="fa fa-trash" aria-hidden="true" style="font-size:30px;color:#fff;" ></i>
						</a>
					</div>
					<div class="col-xs-2">
